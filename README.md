<!-- Banner: save your image as assets/banner.png (recommended ~1280x320) and uncomment the block below -->
<!--
<p align="center">
  <img src="assets/banner.png" alt="UXBanos — CGI generalist & developer" width="880"/>
</p>
-->
...
CGI generalist and developer working from Barcelona, Spain. This page is still a work in progress.
...
I take ownership of the whole pipeline: I prepare the 3D content and work on lighting, materials and art direction, and then build the code, functionality and user interface so the player gets the best possible experience.
...
- Web configurators
- Interactive architecture apps
- Archviz rendering
- Gaussian Splatting
- Tool scripting
- GenAI and AI-assisted coding
...
Barcelona, Spain · UTC+1 · [github.com/UXBanos](https://github.com/UXBanos)
